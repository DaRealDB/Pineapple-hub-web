...
function getTopBarVariant(pathname) {
  console.log('[App] getTopBarVariant called with:', pathname);
...
export default function App() {
  ...
  console.log('[App] Calling useMqtt hook...');
  const {
  ...
  console.log('[App] useMqtt returned:', { mqttConnectionState, availability, dataValid });

  console.log('[App] Calling useWebSocket hook...');
  const {
    connectionState: wsConnectionState,
    pipelineStatus,
  } = useWebSocket();
  console.log('[App] useWebSocket returned:', { wsConnectionState, pipelineStatus });

  const topBarVariant = getTopBarVariant(location.pathname);
  console.log('[App] TopBar variant:', topBarVariant);
